...
/* Swaps the data of list element pointer a and b */
void list_swap(struct list_elem* a, struct list_elem* b) {
    int temp = list_entry(a, struct list_item, elem)->data;
    list_entry(a, struct list_item, elem)->data = list_entry(b, struct list_item, elem)->data;
    list_entry(b, struct list_item, elem)->data = temp;
}
